...
public class AlturaAnoPedroJoão {
	public static void main (String args[]) {
		...
		while (i<=3);
		   ...
		   if (alturaJoao<alturaPedro) {
		       System.out.println("João ainda está menor que Pedro");
		   }else {
	    	   System.out.println("João levou "+i+" anos para ficar mais alto que o Pedro");
		   }		
		}
	}
